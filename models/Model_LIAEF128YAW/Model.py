    ...
    def onInitialize(self, batch_size=-1, **in_options):
        ...
        if self.is_training_mode:
            ...
            self.set_training_data_generators ([            
                    TrainingDataGenerator(self, TrainingDataType.SRC_YAW_SORTED_AS_DST,  batch_size=self.batch_size, output_sample_types_flags=[ f.WARPED_TRANSFORMED | f.FULL_FACE | f.MODE_BGR | f.SIZE_128, f.TRANSFORMED | f.FULL_FACE | f.MODE_BGR | f.SIZE_128, f.TRANSFORMED | f.FULL_FACE | f.MODE_M | f.MASK_FULL | f.SIZE_128], random_flip=True ),
